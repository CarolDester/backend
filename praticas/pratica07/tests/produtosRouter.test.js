...
describe("Testes do recurso /produtos", () => {
  ...
  test("GET /produtos deve retornar 200 e array", async () => {
  ...
  test("GET /produtos/:id inexistente deve retornar 404", async () => {
  ...
  test("PUT /produtos/:id deve atualizar produto (200)", async () => {
    const response = await request
      .put(`${url}/${id}`)
  ...
  test("PUT /produtos/:id inexistente deve retornar 404", async () => {
    const response = await request
